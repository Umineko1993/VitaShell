...
int mountGamecardUx0() {
  ...
  // Copy VitaShell
  copyPath("ux0:app/VITASHELL_JP", "ur0:temp/app", NULL);
  copyPath("ux0:appmeta/VITASHELL_JP", "ur0:temp/appmeta", NULL);
  copyPath("ux0:license/app/VITASHELL_JP", "ur0:temp/license", NULL);
  ...
  sceIoMkdir("ux0:app/VITASHELL_JP", 0006);
  sceIoMkdir("ux0:appmeta/VITASHELL_JP", 0006);
  sceIoMkdir("ux0:license/app/VITASHELL_JP", 0006);
  ...
  sceIoRemove("ux0:VitaShell_JP/internal/lastdir.txt");

  // Copy VitaShell
  copyPath("ur0:temp/app", "ux0:app/VITASHELL_JP", NULL);
  copyPath("ur0:temp/appmeta", "ux0:appmeta/VITASHELL_JP", NULL);
  copyPath("ur0:temp/license", "ux0:license/app/VITASHELL_JP", NULL);
