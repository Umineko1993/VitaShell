...
void initVitaShell() {
  ...
  // Load modules
  patch_modid = taiLoadKernelModule("ux0:VitaShell_JP/module/patch.skprx", 0, NULL);
  if (patch_modid >= 0) {
    int res = taiStartKernelModule(patch_modid, 0, NULL, 0, NULL, NULL);
    if (res < 0)
      taiStopUnloadKernelModule(patch_modid, 0, NULL, 0, NULL, NULL);
  }
  kernel_modid = taiLoadKernelModule("ux0:VitaShell_JP/module/kernel.skprx", 0, NULL);
  if (kernel_modid >= 0) {
